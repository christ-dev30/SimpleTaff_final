    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
        ...
        try {
            ...
            if (jwt != null && jwtUtils.validateJwtToken(jwt)) {
                ...
                UUID entrepriseId = jwtUtils.getEntrepriseIdFromJwtToken(jwt);
                ...
                // Définir le contexte multi-tenant
                if (entrepriseId != null) {
                    TenantContext.setTenantId(entrepriseId);
                }
            }
        } catch (Exception e) {
            e.printStackTrace();
        ...
        try {
            ...
            // Important : nettoyer le contexte
            TenantContext.clear();
        }
    }
